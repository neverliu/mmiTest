...
/* global dump, DEBUG */
/* exported GsensorOrientation */

var GsensorOrientation = (function() {
  'use strict';

  function debug(s) {
    if (DEBUG) {
      dump('<mmitest> ------: [orientation.js] = ' + s + '\n');
    }
  }
  ...
  function getMovingOrientation(x, y, z) {
    var ret = '';
  ...
  function handleMotionEvent(e) {
    ...
    var orientation = getMovingOrientation(x, y, z);
  ...
  function fireOrientationChangeEvent(orientation) {
    debug('fireOrientationChangeEvent');
